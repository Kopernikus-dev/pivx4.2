...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/Kopernikus-dev/pivx4.2/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/kopernikus-dev/pivx4.2/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/kopernikus-dev/pivx4.2-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/kopernikus-dev/pivx4.2.git
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Kopernikus-dev/pivx4.2/releases/new) with a link to the archived release notes.
